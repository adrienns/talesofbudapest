...
export const TOUR_EN = {
  ...
  tagline: 'About 2¼ h · nine revealing places, one complicated capital',
  description: 'A fact-rich first walk through the inventions, bargains, disasters and arguments that made modern Budapest.',
  walkingRoute: WALKING_ROUTE,
  stops: [
    stop('deak-anker', '1. Three Towns, Then a Capital', `
Stand where you can see the broad traffic junction of Deák Ferenc Square and the pale, many-windowed mass of Anker Palace. Begin with an inconvenient fact for anyone who likes a tidy origin story: Budapest was not founded as one city. It was assembled.
...
This walk tests a simple question: what had to happen for three towns to function as one capital? Expect reformers, engineers, financiers and café owners, but also war, dictatorship and contested memory. Walk toward the dome of St Stephen’s Basilica. The streets deliberately narrow before the building fills the view.
    `, ['S01', 'S02', 'S03', 'S30']),

    stop('st-stephens', '2. The Dome That Fell Down', `
Move into the centre of the square and let the Basilica fill your view. Its size is deliberate. In the nineteenth century, Pest was growing at extraordinary speed, and the new districts needed a church that could compete with the city’s secular ambition.
...
The building’s history is more useful than a slogan about grandeur: it shows how large nineteenth-century projects really worked—slowly, with failures, political patience and changing plans. Notice the two bell towers and the deep portico, then lift your eyes to the dome. Its height is about ninety-six metres, traditionally given as the same symbolic height as Parliament. In the skyline, church and legislature face one another as two great institutions of Hungarian public life.
...
Public space is one of Budapest’s historical archives. It is also an active political language. As you leave toward Parliament, carry that uncertainty with you. The next square was designed to project national confidence, yet it too became a place where the state and its citizens confronted one another.
    ...
    stop('parliament-kossuth', '4. Parliament: A Machine for Nationhood', `
...
The Gothic language evokes historic European parliaments, especially Westminster, but the composition is not a copy. The symmetrical plan reflects the two-chamber legislature of the period. The dome rises at the centre, where the two halves meet. Stone carving, stained glass, metalwork, painting and sculpture turned the project into a showcase for Hungarian crafts and industry. It was also high technology: the new building had gas and electric lighting, central heating and cooling, fire protection, telephones and 112 electrically controlled clocks. The building’s scale announced that Budapest no longer saw itself as a provincial city; its systems announced that it did not intend to behave like one either.
...
As you continue around the square, notice how reform took architectural form: an academy for language and science, a bridge for movement and commerce, and public space designed to display both. Your next stop, Gresham Palace, shows what happened when those reforms helped produce an international commercial metropolis.
    ...
    stop('gresham-palace', '7. Gresham Palace: When Insurance Became Spectacle', `
...
From here walk toward Vörösmarty Square. The next stop moves from insurance and investment to another institution of modern Budapest: the café, where business, literature, gossip and the performance of urban life occupied neighbouring tables.
    ...
    stop('vorosmarty-gerbeaud', '8. Coffeehouses: The City’s Original Co-working Space', `
...
On the square stands Café Gerbeaud. Its predecessor was founded by Henrik Kugler in 1858 and moved here in 1870. The Swiss-born confectioner Emil Gerbeaud joined the business in the 1880s and expanded its production and reputation. He introduced the cognac cherry and the cat’s-tongue chocolate to Hungarian confectionery. Fine cakes, chocolates and elaborate interiors made the café a destination, but cafés were not simply places to consume luxury.
...
For the final stop, walk toward the Danube and the Vigadó. We will end not with another list of dates, but by reading the skyline and gathering the nine chapters into one view.
    ...
    stop('vigado-promenade', '9. The River Is the Map', `
...
Take a final moment to choose one detail you would have missed before this walk: a bridge toll paid even by nobles, a former apartment block turned luxury hotel, or two monuments disputing the same past. That is the useful souvenir here: not a list of dates, but a working map of the forces that made the view possible.
...
You began in three former towns and end facing both banks of one capital. Budapest was made through connections repeatedly built, broken and rebuilt—and the city is still arguing about what those connections mean.
    `, ['S27', 'S28', 'S01', 'S29']),
  ],
};
