  ...
  const playbackItem = useMemo<PlaybackItem | null>(() => {
    if (activeChapter && activeRoute) {
      return {
        ...
        imageAttribution: activeChapter.imageAttribution,
        imageAlt: activeChapter.title,
        locationId: activeChapter.locationId ?? activeChapter.landmarkId ?? null,
        landmarkId: activeChapter.locationId ?? activeChapter.landmarkId ?? null,
    ...
    if (selectedLandmark) {
      return {
        ...
        imageAttribution: selectedLandmark.image_attribution,
